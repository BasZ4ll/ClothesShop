    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">เพิ่มสินค้าใหม่</h3>
        </div>
        <!-- /.card-header -->
          ...
          <div class="card-body">
            <div class="form-row">
              <div class="form-group col-md-6">
                  <label for="mem_fname">รูปภาพสินค้า</label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file" id="customFile">
                        <label class="custom-file-label" for="customFile">เพิ่มรูปภาพสินค้า</label>
                    </div><br>
            ...
            <table>
              ...
              <div class="form-group col-md-12">
                  ...
                  <textarea name="product_detail"  id="product_detail" rows="3" class="form-control"></textarea>
              </div>
               <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                  ...
                  <div class="input-group-prepend">
                  <input type="text" class="form-control" id="product_discount" name="product_discount" class="form-control">
                  <div class="input-group-text">เปอร์เซ็น (%)</div>
                  </div>
              </div>
              ...
              <div class="form-group col-md-4">
                  <label for="product_tag">ประเภทสินค้า</label>
