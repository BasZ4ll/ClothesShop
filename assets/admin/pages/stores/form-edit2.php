          ...
          <div class="card-body">
              ...
              <div class="form-group col-md-6">
                  <label for="mem_fname">รูปภาพสินค้า</label>
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile" >แก้ไขรูปภาพสินค้า</label>
                    </div><br>
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                  ...
                  <div class="input-group-prepend">
                  <input type="text" class="form-control" id="product_discount" name="product_discount" class="form-control" value="<?php echo $rows['product_discount']?>">
