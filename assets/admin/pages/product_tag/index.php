    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">รายการประเภทสินค้า</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped w-100 ">
            ...
            <tr>
              <th>#</th>
              <th>ไอดีประเภทสินค้า</th>
              <th>ชื่อประเภทสินค้า</th>
              <th>วันที่</th>
              <th><a href="form_insert.php" class="btn btn-success"><i class="fas fa-plus-square"></i> เพิ่มประเภทสินค้าใหม่</a></th>
            </tr>
            </thead>
            <tbody>
