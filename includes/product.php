      ...
      <div class="card-deck ">
        ...
        <?php while ($row = mysqli_fetch_array($res)) { ?>
          ...
          <!-- <div class="col-sm-4" style="padding: 20px;padding-left: 90px;"> -->
            <div class="card card-block" data-toggle="modal" data-target="#myModal<?php echo $row["product_id"]; ?>">
              ...
              <div class="card-body">
                ...
                <a class="card-link fonts" style="color:black;margin-left: 100px"><?php echo number_format($row['product_price'], 2) ?> บาท</a>
              </div>
              <!-- /////////////////////  -->
              <p class="card-text">
