    ...
    <div class="row">
      <div class="card-deck">
        <?php while ($row = mysqli_fetch_array($res)) { ?>
          <div class="col-sm-4 ">
            <div class="card card-block"><a class="card-link" data-toggle="modal" data-target="#myModal<?php echo $row["product_id"]; ?>">
              <span class="shopping-mall-tagn">ใหม่ </span><span class="shopping-mall-tag">Sale! </span>
              ...
              <div>
              <a class="card-link fonts" style="color:black;margin-left: 160px;"><?php echo number_format($row['product_price'], 2) ?>฿</a>
              </div>
              <!-- /////////////////////  -->
              <p class="card-text">
